...
_wrap_librdf_parser_guess_name2(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "unsigned char const *","librdf_parser_guess_name2", 3, argv[2] )); 
  }
  arg3 = (unsigned char *)(argp3);
  res4 = SWIG_ConvertPtr(argv[3], &argp4,SWIGTYPE_p_unsigned_char, 0 |  0 );
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), Ruby_Format_TypeError( "", "unsigned char const *","librdf_parser_guess_name2", 4, argv[3] )); 
  }
